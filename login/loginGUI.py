...
class LoginGUI:
    def __init__(self, document_manage, window):
        ...
        dms_label = tk.Label(login_frame, text="DOCUMENT MANAGEMENT SYSTEM", font=("", 20, "bold"), bg="white")
        ...
        username_label = tk.Label(login_frame, text="Username:",bg="white", font=("", 12))
        ...
        password_label = tk.Label(login_frame, text="Password:",bg="white", font=("", 12))
        ...
        login_button = tk.Button(login_frame, text="Sign in", font=("", 12), height=2, background="#1E88E5", foreground="white", command=lambda: login.signin(self.document_manage, self.window))
        login_button.grid(row=3, column=0, columnspan=2, padx=10, pady=10, sticky=tk.NSEW)

        # create the "sign up" link
        signup_link = tk.Label(login_frame, text="No account? Sign up here.", font=("", 12), bg="white", cursor="hand2", fg="blue")
        ...
        forget_label = tk.Label(login_frame, text="Forget password?", font=("", 12), bg="white", cursor="hand2", fg="blue")

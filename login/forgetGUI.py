...
class ForgetGUI:
    def __init__(self, window):
        ...
        prompt_user = tk.Label(recover_frame, text="If you have an admin account and you lost it, please contact the developers.")
        ...
        account_label.grid(row=1, column=0, padx=10, pady=10, sticky=tk.W)
        self.account_input = tk.Entry(recover_frame,width=48)
        self.account_input.grid(row=1, column=1, padx=10, pady=10, sticky=tk.W)

        recoverycode_label = tk.Label(recover_frame, text="Recovery Code:")
        recoverycode_label.grid(row=2, column=0, padx=10, pady=10, sticky=tk.W)
        self.recoverycode_input = tk.Entry(recover_frame,width=48)
        self.recoverycode_input.grid(row=2, column=1, padx=10, pady=10, sticky=tk.W)

        recover_button = tk.Button(recover_frame, text="Recover", width=10, height = 1, command=self.recover_password)
        recover_button.grid(row=3, column=0, padx=10, pady=10, sticky=tk.NSEW)
